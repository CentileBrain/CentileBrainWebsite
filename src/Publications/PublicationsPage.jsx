...
export default function PublicationsPage(props) {
    ...
    const publications = [
       ...
       },
       {
        ...
        {
           info: 'Zhang X, Yu Y, Liu X, Fang Y, Wang J, Frangou S, Zang Y, Ge R, Zhang H. Medication and Developmental Stage Shape the Brain-Age Gap in ADHD. BioRXiv. doi: 10.64898/2026.01.19.700322',
