        ...
        <sections>
            ...
            <Grid container spacing={3} alignItems={'center'}>
                ...
                <Grid item xs={12} md={3}>
                    <Box sx={{ minWidth: 120 }}>
                        <FormControl fullWidth>
                            <InputLabel id="gender-label">Select Sex</InputLabel>
                            <Select
                ...
                <Grid item xs={12} md={3}>
                    <Box sx={{ minWidth: 120 }}>
                        <FormControl fullWidth>
                            <InputLabel id="MM-label">
                                Select Morphometric Measure
                            </InputLabel>
                            <Select
                                labelId="MM-label"
                                id="MM-select"
                ...
                <Grid item xs={12} md={3}>
                    <Box sx={{ minWidth: 120 }} hidden={morphometric !== 'volumes'}>
                        <FormControl fullWidth>
                            ...
                            >
                                ...
                                <MenuItem value={'hippocampus'}>
                                    Hippocampus
                                </MenuItem>
                                <MenuItem value={'amygdala'}>Amygdala</MenuItem>
                                <MenuItem value={'nucleusaccumbens'}>
                                    Nucleus Accumbens
                                </MenuItem>
                            </Select>
                        </FormControl>
                    ...
                    <Box
                        sx={{ minWidth: 120 }}
                        hidden={morphometric !== 'thickness'}
                    >
                        <FormControl fullWidth>
                            <InputLabel id="thickness-label">
                                Regional Cortical Thickness
                            </InputLabel>
                            <Select
